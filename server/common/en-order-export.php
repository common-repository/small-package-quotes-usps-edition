...
namespace EnUspsOrderExport;

/**
 * Get and save settings.
 * Class EnUspsOrderExport
 * @package EnUspsOrderExport
 */
if (!class_exists('EnUspsOrderExport')) {
    ...
    class EnUspsOrderExport
    {
        ...
        public function en_orders_sending($orders, $en_orders_ids)
        {
            ...
            $response = \EnUspsCurl\EnUspsCurl::en_usps_sent_http_request(EN_USPS_ORDER_EXPORT_HITTING_URL, $post_data, 'POST', 'Export Order');
