...
namespace EnUspsFreightdeskOnline;
 ...
 */
if (!class_exists('EnUspsFreightdeskOnline')) {

    class EnUspsFreightdeskOnline
    {
        ...
        static public function en_load()
        {
            ...
            if (get_option('en_fdo_company_id_status') != 1) {
                $button_connect = '<a href="javascript:void(0)" id="fd_online_id_usps" class="button-primary">Connect</a>';
        ...
        <p>
            ...
            To establish a connection, you must have a FreightDesk Online account. If you don’t have one, ' . $link_register . ' to register.
                ...
                if (get_option('en_fdo_company_id_status') == 1) {
                    $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_usps" class="button-primary">Disconnect</a>';
